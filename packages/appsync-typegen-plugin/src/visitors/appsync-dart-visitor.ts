import { AppSyncModelVisitor, ParsedAppSyncModelConfig, RawAppSyncTypeConfig, CodeGenModel, CodeGenField, CodeGenGenerateEnum } from './appsync-visitor';
...
export class AppSyncModelDartVisitor<
  TRawConfig extends RawAppSyncTypeConfig = RawAppSyncTypeConfig,
