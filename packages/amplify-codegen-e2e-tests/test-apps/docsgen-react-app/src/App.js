...
function App() {
  ...
  return (
    <div className="App">
      ...
      <button name="generateDocuments" onClick={handleGenerateButtonClick}>
      ...
      <button name="testGraphQLOperations" onClick={handleGraphQLOperationsButtonClick}>
        Test Generated GraphQL Operations
      </button>
