 ...
 */
export function getConnectedFieldsForHasOne(
  otherSideBelongsToField: CodeGenField | undefined,
  otherSide: CodeGenModel,
  shouldUseFieldsInAssociatedWithInHasOne: boolean = false,
): CodeGenField[] {
  return !shouldUseFieldsInAssociatedWithInHasOne && otherSideBelongsToField
    ? [otherSideBelongsToField]
